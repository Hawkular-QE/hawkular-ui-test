...
public class HawkularAppServerJVMConstants {
    ...
    public static final By createAlertEveryTimeOptionLocator = By
            .xpath("//label[@for='every-time-heap']");
    public static final By createAlertWhenConditionOptionLocator = By
            .xpath("//label[@for='greater-time-heap']");
